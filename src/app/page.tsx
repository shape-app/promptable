  ...
  return (
    <>
      ...
      <div className='max-w-2xl mx-auto p-4 text-gray-800'>
        ...
        <div className='mb-6'>
          Tired of scrolling through chat history just to
          find specific prompts? Can&apos;t find a central
          place to save your customized prompts? Find
          highlighting the entire text for copying too slow
          and tedious? <br />
          Promptable is a web app designed to tackle these
          challenges for users of AI powerhouses like
          ChatGPT and Bard.
        </div>
        <div className='text-xl font-bold mb-4'>Team</div>
        <div className='mb-10'>
          Promptable is developed and maintained by Shape, a
          community-driven organization focused on exploring
          a shared interest in software products. <br />
          Visit our{' '}
          <a
          ...
          to learn more. For inquiries or feedback, please
          email us at{' '}
          <a
            className='text-gray-600 font-bold'
        ...
        <div className='text-sm'>
          &copy; Copyright {currentYear} Promptable. All
          rights reserved.
        </div>
      </div>
    </>
